...
public class ConsultarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jtCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Logradouro", "Número", "Complemento", "CEP", "Cidade", "Bairro", "Estado", "Status"
            }
        ) {
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            ...
            for (Cliente cli : clientes) {
                String[] linha = {String.valueOf( cli.getCodigo() ), cli.getNome(), cli.getEndereco().getLogradouro(), cli.getEndereco().getNumero(),
                    cli.getEndereco().getComplemento(), cli.getEndereco().getCep(), cli.getEndereco().getCidade(), cli.getEndereco().getBairro(), cli.getEndereco().getEstado(), String.valueOf(cli.getAtivo()) };
                model.addRow(linha);
            }
